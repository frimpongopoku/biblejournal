      ...
      {open && prayer && (
        <>
          ...
          <motion.div
            ...
            style={{ maxWidth: 440, transform: "translate(-50%, -50%)" }}
          >
            <div
            ...
            >
              ...
              <div className="px-6 py-5 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label
                    ...
                    style={{ color: "var(--bj-ink4)" }}
                  >
                    How did God answer? <span style={{ opacity: 0.6, textTransform: "none", letterSpacing: 0 }}>(optional)</span>
                  </label>
                  <textarea
                    ref={areaRef}
                    value={testimony}
              ...
              >
                ...
                <button
                  ...
                  disabled={saving}
                  className="bj-btn-primary font-sans text-sm px-4 py-2 rounded-xl flex items-center gap-2 disabled:opacity-50"
                  style={{
